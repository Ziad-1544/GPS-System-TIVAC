...
/*************************************************ERROR FIXED AND MESSAGE*****************************************************/

			// Changes is up there the code before was:
			// SET_BIT(Local_Port->GPIOAFSEL, Copy_PinId);
      // u32 mask = 0xF << (Copy_PinId * 4);
			
			// ERROR Statement:
			// GPIO_program.c(359): error: #268: declaration may not appear after executable statement in block
